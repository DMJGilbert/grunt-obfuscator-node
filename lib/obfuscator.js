...
var astString = function(node) {
    ...
    obj.value = hex;
    return new terser.AST_String(obj);
};

var compress = function (ast, opts) {
    opts = opts || options;
    var compressor = terser.Compressor(opts);
...
module.exports.parse = function(src,options,cb){
    ...
    try{
        ...
        var ast = terser.parse(src);
        var stream = new terser.OutputStream;
        ...
        if (options.strings) {
            var transformer = new terser.TreeTransformer(null, astString);
